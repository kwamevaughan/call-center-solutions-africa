      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <OptimizedInput
            ...
            onChange={memoizedHandlers.canonicalUrl}
            placeholder="https://example.com/canonical-url"
            mode={mode}
            type="url"
          />
          <div className="text-xs text-gray-500">
            Preferred URL if this content exists elsewhere
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <OptimizedInput
            ...
            onChange={memoizedHandlers.ogTitle}
            placeholder="Title for social media sharing"
            mode={mode}
          />
          <div className="text-xs text-gray-500">
            Title shown when shared on social media (defaults to meta title)
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <OptimizedTextarea
            ...
            onChange={memoizedHandlers.ogDescription}
            placeholder="Description for social media sharing"
            mode={mode}
            rows={2}
          />
          <div className="text-xs text-gray-500">
            Description shown when shared on social media (defaults to meta description)
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <OptimizedSelect
            ...
            onChange={memoizedHandlers.twitterCard}
            options={[
              { id: "summary", name: "Summary" },
              { id: "summary_large_image", name: "Summary Large Image" },
              { id: "app", name: "App" },
          ...
          />
          <div className="text-xs text-gray-500">
            How the link appears on Twitter
          </div>
        </div>
      </div>
