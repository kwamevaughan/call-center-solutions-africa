          ...
          <div className="max-w-7xl mx-auto w-full relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold leading-tight">
                Fast, compliant case handling
              </h1>
              <p className="text-sm sm:text-base md:text-lg leading-relaxed text-white/90">
                Insurance, fintech, and e-commerce cases processed with accuracy, transparency, and complete audit trails.
              </p>
            ...
            <div className="relative z-10 mx-auto max-w-7xl py-12 sm:py-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 sm:p-8 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">Regulatory adherence</h3>
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    With consistent decision criteria
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 sm:p-8 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">Customer trust preserved</h3>
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    Via timely updates and clear evidence requests
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 sm:p-8 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">Full auditability</h3>
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    With documented steps, timestamps, and outcomes
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 mx-auto max-w-7xl py-12 sm:py-20">
              ...
              <div className="flex flex-col gap-3 sm:gap-4 max-w-3xl mx-auto">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 sm:p-5 flex items-start gap-3 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  ...
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    Claims intake, validation, and document review
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 sm:p-5 flex items-start gap-3 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <Icon icon="mdi:check-circle" width={20} height={20} className="text-ccsa-yellow flex-shrink-0 mt-0.5" />
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    Dispute handling, evidence collection, and merchant/customer liaison
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 sm:p-5 flex items-start gap-3 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <Icon icon="mdi:check-circle" width={20} height={20} className="text-ccsa-yellow flex-shrink-0 mt-0.5" />
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    KYC/KYB/AML checks, identity/document verification, sanctions screening
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 sm:p-5 flex items-start gap-3 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <Icon icon="mdi:check-circle" width={20} height={20} className="text-ccsa-yellow flex-shrink-0 mt-0.5" />
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    Exception handling, appeals, and regulatory reporting support
                  </p>
                </div>
              </div>
            </div>
...
export default ClaimsDisputeVerificationPage;
