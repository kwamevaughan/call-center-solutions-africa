            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="flex items-center justify-center lg:justify-end">
                <div className="relative w-full max-w-md">
                  <Image
                    src="https://ik.imagekit.io/nkmvdjnna/CCSA/services/inbound-hero.webp"
            ...
            <div className="relative z-10 mx-auto max-w-7xl py-12 sm:py-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 sm:p-8 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">CSAT & FCR up</h3>
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    Playbooks + real-time QA lift quality while reducing AHT.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 sm:p-8 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">On‑brand always</h3>
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
                    Macros, KB updates, and clean L2/L3 escalations.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 sm:p-8 transform transition-transform duration-300 hover:translate-y-[-5px]">
                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">True 24/7</h3>
                  <p className="text-sm sm:text-base leading-relaxed text-white/90">
...
export default InboundOutboundCustomerServicePage;
