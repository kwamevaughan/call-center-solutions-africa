        ...
        <div className="flex-grow px-4 py-16 max-w-6xl mx-auto">
          ...
          <section className="space-y-6 text-gray-700">
            ...
            <div>
              ...
              <p>
                Welcome to Call Center Solutions Africa. We are committed to
                ...
                ) or interact with us through our contact forms or other
                services.
              </p>
              <p className="mt-2">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>
                  ...
                  contact form, we collect your first name, second name, email
                  address, phone number (optional), organization (optional), and
                  any message you provide.
                </li>
                <li>
                  <strong>Automatically Collected Information:</strong> We may
                  collect information about your device and how you interact
                  with our website, such as your IP address, browser type, pages
                  visited, and the date and time of your visit, using cookies
                  and similar technologies.
                </li>
                <li>
                  <strong>Third-Party Data:</strong> If you interact with us
                  through third-party platforms (e.g., social media), we may
                  collect information provided by those platforms, subject to
            ...
            <div>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>
                  <strong>To Respond to Your Inquiries:</strong> We use your
                  personal information to respond to your messages and inquiries
                  submitted through our contact form.
                </li>
                <li>
                  <strong>To Send Confirmation Emails:</strong> We send a
                  confirmation email to acknowledge receipt of your message.
                </li>
                <li>
                  <strong>To Improve Our Services:</strong> We analyze
                  automatically collected data to understand how users interact
                  with our website and improve its functionality and content.
                </li>
                <li>
                  <strong>To Communicate with You:</strong> We may use your
                  email address to send updates, newsletters, or promotional
                  materials related to Call Center Solutions Africa, but only
            ...
            <div>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>
                  ...
                  email service providers) who assist us in operating our
                  website and delivering our services, subject to
                ...
                <li>
                  <strong>Business Transfers:</strong> If Call Center Solutions
                  Africa is involved in a merger, acquisition, or sale of
            ...
            <div>
              ...
              <p>
                ...
                using secure servers, encryption, and access controls. However,
              ...
              <p className="mt-2">
                ...
                no longer secure, please contact us immediately at{" "}
                <a
            ...
            <div>
              ...
              <p>
                ...
                experience on our website, analyze usage, and deliver
                personalized content. Our website may also function as a
                Progressive Web App (PWA), which allows you to add it to your
                device’s home screen for easier access. This feature does not
                collect additional personal information beyond what is already
            ...
            <div>
              ...
              <p>
                ...
                our website with a new "Last Updated" date. We encourage you to
